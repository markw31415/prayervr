...
{
    public class MacAGGControllerMapping : BaseAGGControllerMapping
    {
        public override List<UnityInputAxes> fetchMappingObject(string name, AutoGamepadConstants.DEFAULT_CONTROLLER_MAPPING control, AutoGamepadConstants.UNITY_PLAYER_NUMBER player)
        {
            ...
            switch (control)
            {
                ...
                case AutoGamepadConstants.DEFAULT_CONTROLLER_MAPPING.DpadHorizontal:
                    inputAxis = createAxis(name, "button 8", "button 7", player, AutoGamepadConstants.ITEM_TYPE.Digital, AutoGamepadConstants.UNITY_AXIS_TYPE.KeyOrMouseButton, AutoGamepadConstants.UNITY_AXIS_NUMBER.SixthAxis, false);
                ...
                case AutoGamepadConstants.DEFAULT_CONTROLLER_MAPPING.DpadVertical:
                    inputAxis = createAxis(name, "button 5", "button 6", player, AutoGamepadConstants.ITEM_TYPE.Digital, AutoGamepadConstants.UNITY_AXIS_TYPE.KeyOrMouseButton, AutoGamepadConstants.UNITY_AXIS_NUMBER.SeventhAxis, false);
                    inputAxisCollection.Add(inputAxis);
                    inputAxis = createAxis(name, "", "", player, AutoGamepadConstants.ITEM_TYPE.Analog, AutoGamepadConstants.UNITY_AXIS_TYPE.JoystickAxis, AutoGamepadConstants.UNITY_AXIS_NUMBER.EighthAxis, true);
                    break;
                ...
                case AutoGamepadConstants.DEFAULT_CONTROLLER_MAPPING.LeftTrigger_ControllerSpecific:
                    inputAxis = createAxis(name, "", "", player, AutoGamepadConstants.ITEM_TYPE.Analog, AutoGamepadConstants.UNITY_AXIS_TYPE.JoystickAxis, AutoGamepadConstants.UNITY_AXIS_NUMBER.FifthAxis, false);
                    break;
                case AutoGamepadConstants.DEFAULT_CONTROLLER_MAPPING.RightTrigger_ControllerSpecific:
                    inputAxis = createAxis(name, "", "", player, AutoGamepadConstants.ITEM_TYPE.Analog, AutoGamepadConstants.UNITY_AXIS_TYPE.JoystickAxis, AutoGamepadConstants.UNITY_AXIS_NUMBER.SixthAxis, false);
                    break;
                case AutoGamepadConstants.DEFAULT_CONTROLLER_MAPPING.A_Button:
                    inputAxis = createAxis(name, "button 16", "", player, AutoGamepadConstants.ITEM_TYPE.Digital, AutoGamepadConstants.UNITY_AXIS_TYPE.KeyOrMouseButton, AutoGamepadConstants.UNITY_AXIS_NUMBER.X_Axis_1st, false);
                    inputAxisCollection.Add(inputAxis);
                ...
                case AutoGamepadConstants.DEFAULT_CONTROLLER_MAPPING.B_Button:
                    inputAxis = createAxis(name, "button 17", "", player, AutoGamepadConstants.ITEM_TYPE.Digital, AutoGamepadConstants.UNITY_AXIS_TYPE.KeyOrMouseButton, AutoGamepadConstants.UNITY_AXIS_NUMBER.X_Axis_1st, false);
                    inputAxisCollection.Add(inputAxis);
                ...
                case AutoGamepadConstants.DEFAULT_CONTROLLER_MAPPING.X_Button:
                    inputAxis = createAxis(name, "button 18", "", player, AutoGamepadConstants.ITEM_TYPE.Digital, AutoGamepadConstants.UNITY_AXIS_TYPE.KeyOrMouseButton, AutoGamepadConstants.UNITY_AXIS_NUMBER.X_Axis_1st, false);
                    inputAxisCollection.Add(inputAxis);
                ...
                case AutoGamepadConstants.DEFAULT_CONTROLLER_MAPPING.Y_Button:
                    inputAxis = createAxis(name, "button 19", "", player, AutoGamepadConstants.ITEM_TYPE.Digital, AutoGamepadConstants.UNITY_AXIS_TYPE.KeyOrMouseButton, AutoGamepadConstants.UNITY_AXIS_NUMBER.X_Axis_1st, false);
                    inputAxisCollection.Add(inputAxis);
