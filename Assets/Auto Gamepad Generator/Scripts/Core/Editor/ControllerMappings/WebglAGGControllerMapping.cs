...
{
    public class WebglAGGControllerMapping : BaseAGGControllerMapping
    {
        public override List<UnityInputAxes> fetchMappingObject(string name, AutoGamepadConstants.DEFAULT_CONTROLLER_MAPPING control, AutoGamepadConstants.UNITY_PLAYER_NUMBER player)
        {
            ...
            switch (control)
            {
                ...
                case AutoGamepadConstants.DEFAULT_CONTROLLER_MAPPING.DpadHorizontal:
                    inputAxis = createAxis(name, "button 15", "button 14", player, AutoGamepadConstants.ITEM_TYPE.Digital, AutoGamepadConstants.UNITY_AXIS_TYPE.KeyOrMouseButton, AutoGamepadConstants.UNITY_AXIS_NUMBER.X_Axis_1st, false);
                    break;
                case AutoGamepadConstants.DEFAULT_CONTROLLER_MAPPING.DpadVertical:
                    inputAxis = createAxis(name, "button 12", "button 13", player, AutoGamepadConstants.ITEM_TYPE.Digital, AutoGamepadConstants.UNITY_AXIS_TYPE.KeyOrMouseButton, AutoGamepadConstants.UNITY_AXIS_NUMBER.X_Axis_1st, false);
                    break;
