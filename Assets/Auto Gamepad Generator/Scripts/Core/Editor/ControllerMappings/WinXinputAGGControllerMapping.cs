...
{
    public class WinXinputAGGControllerMapping : BaseAGGControllerMapping
    {
        public override List<UnityInputAxes> fetchMappingObject(string name ,AutoGamepadConstants.DEFAULT_CONTROLLER_MAPPING control, AutoGamepadConstants.UNITY_PLAYER_NUMBER player)
        {
            ...
            switch(control)
            {
                ...
                case AutoGamepadConstants.DEFAULT_CONTROLLER_MAPPING.DpadVertical:
                    inputAxis = createAxis(name, "", "", player, AutoGamepadConstants.ITEM_TYPE.Digital, AutoGamepadConstants.UNITY_AXIS_TYPE.JoystickAxis, AutoGamepadConstants.UNITY_AXIS_NUMBER.SeventhAxis, false);
                    break;
                ...
                case AutoGamepadConstants.DEFAULT_CONTROLLER_MAPPING.LeftTrigger_ControllerSpecific:
                    inputAxis = createAxis(name, "", "", player, AutoGamepadConstants.ITEM_TYPE.Analog, AutoGamepadConstants.UNITY_AXIS_TYPE.JoystickAxis, AutoGamepadConstants.UNITY_AXIS_NUMBER.NinthAxis, false);
                    break;
                case AutoGamepadConstants.DEFAULT_CONTROLLER_MAPPING.RightTrigger_ControllerSpecific:
                    inputAxis = createAxis(name, "", "", player, AutoGamepadConstants.ITEM_TYPE.Analog, AutoGamepadConstants.UNITY_AXIS_TYPE.JoystickAxis, AutoGamepadConstants.UNITY_AXIS_NUMBER.TenthAxis, false);
                    break;
